<main class="d-flex justify-content-center align-items-center bg-user-form">
	<form class="container p-5 form-user d-flex justify-content-center flex-column position-relative" action="./controller/controllerUser.php" method="post">
		...
		<div class="row">
			...
			<div class="password-container col-12 p-0 m-0">
				<input class="col-11" type="password" name="confirm_password" id="confirm_password" required /><button class="col-1 btn-eye" type="button" onclick="toogleVisibility(confirm_password, this)" class="col-1"><i class="fa fa-eye"></i></button>
			</div>
		</div>
