<main class="container">
    <section class="row justify-content-center">
        <img class="img-user col-6 col-md-3 rounded-circle border border-primary" src="<?= sprintf("%s/%s", constant("URL"), substr($profile['image_path'], 3)) ?>" alt="" />
    </section>
                    ...
                    <div class="col-6 col-sm-3 my-4">
                        ...
                        <a href="?page=product&idP=<?= $product['id'] ?>" style="text-decoration: none;">
                            <div class="card w-100 text-center border-0">
                                <img class="card-img-top" src="<?= sprintf("%s/%s", constant("URL"), substr($product['image_path'], 3)) ?>" style="height: 20vw; max-height: 300px; min-height: 100px;" alt="Card image">
                                <div class="card-body">
                    ...
                    <div class="col-6 col-sm-3 my-4">
                        <a href="?page=product&idP=<?= $product['id'] ?>" style="text-decoration: none;">
                            <div class="card w-100 text-center border-0">
                                <img class="card-img-top" src="<?= sprintf("%s/%s", constant("URL"), substr($product['image_path'], 3)) ?>" style="height: 20vw; max-height: 300px; min-height: 100px;" alt="Card image">
                                <div class="card-body">
                                    <h4 class="card-title"><?= $product['name'] ?>AA</h4>
                                    <p class="card-text">R$ <?= $product['price'] ?></p>
                                </div>
                            </div>
                        </a>
