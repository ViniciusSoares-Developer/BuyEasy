<main class="d-flex justify-content-center align-items-center bg-user-form">
	<form class="container p-5 form-user d-flex flex-column position-relative" action="./controller/controllerUser.php" method="post">
		...
		<label class="row"> <span class="m-1">Login:</span> <input type="text" placeholder="Email / Nome de usuario" name="name" required /> </label>
		<div class="row mt-2">
		...
		<div class="row mt-2">
			<label class="col-6 d-flex align-items-center">
				<input type="checkbox" name="remeber" /> <span>Lembrar-se</span>
			</label>
